const PrivacyPolicy = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to GSC-Fingerprint.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to GSC-Fingerprint, accessible from{" "}
            <a href="https://gsc-fingerprint.org" rel="external nofollow noopener" target="_blank">
              https://gsc-fingerprint.org
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: kyumin12271227@gmail.com</li>
      </ul>
    </>
  );
};
